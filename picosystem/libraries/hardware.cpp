...
namespace picosystem {
  ...
  enum pin {
    RED = 1, GREEN = 11, BLUE = 8,                  // user rgb led
    CS = 17, SCK = 18, MOSI  = 19,                       // spi
    VSYNC = 0, DC = 20, LCD_RESET = 21, BACKLIGHT = 22, // screen
    AUDIO = 15,                                       // audio
    CHARGE_LED = 25, CHARGING = 24, BATTERY_LEVEL = 29 // battery / charging
  };
...
return false;
  ...
  void _wait_vsync() {
sleep_ms(16);
    return;  // now wait for vsync to occur
  }
