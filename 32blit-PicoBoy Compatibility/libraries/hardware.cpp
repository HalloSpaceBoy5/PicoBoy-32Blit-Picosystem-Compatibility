...
namespace picosystem {
  ...
  enum pin {
    RED = 11, GREEN = 1, BLUE = 0,                  // user rgb led
    CS = 17, SCK = 18, MOSI  = 19,                       // spi
    VSYNC = 16, DC = 20, LCD_RESET = 21, BACKLIGHT = 22, // screen
    AUDIO = 15,                                       // audio
    CHARGE_LED = 26, CHARGING = 27, BATTERY_LEVEL = 28 // battery / charging
  };
